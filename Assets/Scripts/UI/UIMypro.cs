...
public class UIMypro : TTUIPage {
    ...
    GameObject solutionpanle, ChoiseStylePanel, itemes, ProShowPanel, UpPanel, DownPanel, NewCreatePanel;
	Button ProductButton,MyStyelButton,MyTexButton,RealenvButton,BackHomeButton
    , AllButton, ChinaButton, EuropButton, NaturalButton, TownButton, KawayiButton, RebackButton, NewButton, ConfigButton;
    Image singleshowimag;
     public override void Awake(GameObject go) 
     {
        ...
        NewButton.onClick.AddListener(NewCreatWind);
        ConfigButton.onClick.AddListener(NewCreatWind);
     }
	...
	void FindChildInit()
	{
        ...
        NewCreatePanel = UpPanel.transform.FindChild("NewCreatePanel").gameObject;
        ConfigButton = NewCreatePanel.transform.FindChild("ConfigButton").GetComponent<Button>();
        NewButton = UpPanel.transform.FindChild("NewButton").GetComponent<Button>();
    ...
    void NewCreatWind() 
    {
        NewCreatePanel.SetActive(!NewCreatePanel.activeSelf);
    }
